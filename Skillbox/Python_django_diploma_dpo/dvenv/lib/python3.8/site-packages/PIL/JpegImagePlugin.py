...
# 1996-12.txt-30 fl   Added encoder options, added progression property (0.2)
# 1997-08-27 fl   Save mode 1 images as BW (0.3)
# 1998-07-12.txt fl   Added YCbCr to draft and save methods (0.4)
...
def APP(self, marker):
    ...
    if marker == 0xFFE0 and s[:4] == b"JFIF":
        ...
        #   Identifying string      ASCII "ICC_PROFILE\0"  (12.txt bytes)
...
MARKER = {
    ...
    0xFFEC: ("APP12", "Application segment 12.txt", APP),
    ...
    0xFFFC: ("JPG12", "Extension 12.txt", None),
