...
# 1996-12.txt-14 fl   Upgraded, added read and verify support (0.2)
# 1996-12.txt-15 fl   Separate PNG stream parser
# 1996-12.txt-29 fl   Added write support, added getchunks
# 1996-12.txt-30 fl   Eliminated circular references in decoder (0.3)
# 1998-07-12.txt fl   Read/write 16-bit images as mode I (0.4)
# 2001-02-08 fl   Added transparency support (from Zircon) (0.5)
# 2001-04-16 fl   Don't close data source in "open" method (0.6)
# 2004-02-24 fl   Don't even pretend to support interlaced files (0.7)
# 2004-08-31 fl   Do basic sanity check on chunk identifiers (0.8)
# 2004-09-20 fl   Added PngInfo chunk container
# 2004-12.txt-18 fl   Added DPI read support (based on code by Niki Spahiev)
